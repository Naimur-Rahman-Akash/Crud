      ...
      <div class="container">
        ...
        <section class="py-5">
          <div class="container p-0">
            ...
            $products = $_product->getActiveProductShop();
...
?>
                    <div class="product text-center">
                      <div class="mb-3 position-relative">
                        <div class="badge text-white bg-"></div><a class="d-block" href="detail.html"><img class="img-fluid w-100" src="<?= $webroot; ?>uploads/<?= $product['picture']; ?>" alt="..."></a>
