        ...
        <div class="container">
          <div class="row mb-5">
              ...
              <div class="row m-sm-0">
                ...
                <div class="col-sm-10 order-1 order-sm-2">
                  <div class="swiper product-slider">
                    <div class="swiper-wrapper">
                      <div class="swiper-slide h-auto"><a class="glightbox product-view" href="img/product-detail-1.jpg" data-gallery="gallery2" data-glightbox="Product item 1"><img class="img-fluid" src="<?= $webroot; ?>uploads/<?= $products['picture'];?>" alt="..."></a></div>
            ...
            <div class="col-lg-6">
              ...
              <p class="text-sm mb-4"><?= $products['description']; ?></p>
              ...
              <ul class="list-unstyled small d-inline-block">
                ...
                <li class="px-3 py-2 mb-1 bg-white text-muted"><strong class="text-uppercase text-dark">Category:</strong><a class="reset-anchor ms-2" href="#!"><?= $products['product_type']; ?></a></li>
          ...
          <div class="row">
            ...
            $products = $_product->getActiveProduct2();
...
?>
              <div class="product text-center skel-loader">
                <div class="d-block mb-3 position-relative"><a class="d-block" href="detail.php?id=<?=$product['id'];?>"><img class="img-fluid w-100" src="<?= $webroot; ?>uploads/<?= $product['picture']; ?>" alt="..."></a>
                ...
                <h6> <a class="reset-anchor" href="detail.php?id=<?=$product['id'];?>"><?= $product['title']; ?></a></h6>
