        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-5">
                    ...
                    <div class="mb-3">
                            <label for="inputPomoMgs" class="col-md-3 col-form-label">Promotional Messgae:</label>
                            <div class="col-md-9">
                            <input type="text" class="form-control" id="inputPromoMgs" name="Promo_mgs" value="">
                        </div>
                        </div>
                        <div class="col-auto">
