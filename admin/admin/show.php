        ...
        <div class="row justify-content-center">
            <div class="col-md-5">
                ...
                <dl class="row">
                    ...
                    <dd class="col-md-10"><?=$admin['id'];?></dd>
                </dl>
                <dl class="row">
                    <dt class="col-md-2">Name:</dt>
                    <dd class="col-md-10"><?=$admin['name'];?></dd>
                </dl>
                <dl class="row">
                    <dt class="col-md-3">Is Draft:</dt>
                    <dd class="col-md-9">
                        <?php
                        echo $admin['is_draft']? 'Drafted':'Not Drafted';
                ...
                <dl class="row">
                    ...
                    <dd class="col-md-9"><?=$admin['created_at'];?></dd>
                </dl>
                <dl class="row">
                    <dt class="col-md-3">Modified At:</dt>
                    <dd class="col-md-9"><?=$admin['modified_at'];?></dd>
                </dl>
                <dl class="row">
                    <dt class="col-md-2">Email:</dt>
                    <dd class="col-md-10"><?=$admin['email'];?></dd>
                </dl>
            </div>
        </div>
    </div>
